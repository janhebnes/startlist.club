/* MIGRATION BATCH FROM RELEASE 1.0 to RELEASE 2.0 OF THE FLIGHT JOURNAL DATABASE LAYER */ 
...
INSERT INTO FlightJournal.dbo.Planes(PlaneId, Registration, CompetitionId, Seats, Engines, EntryDate, ExitDate, StartTypeId) SELECT * FROM [FlightLog.Models.FlightContext].dbo.Planes 
